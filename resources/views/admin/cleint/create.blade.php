...
@section('content')
    ...
    <div class="card card-dark">
        <div class="card-header">
			...
			{{ !empty($title)?$title:'' }}
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a href="{{ aurl('cleint') }}" style="color:#343a40" class="dropdown-item">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['url'=>aurl('/cleint'),'id'=>'cleint','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('to_country',old('to_country'),['class'=>'form-control','placeholder'=>trans('admin.to_country')]) !!}--}}
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('to_city',old('to_city'),['class'=>'form-control','placeholder'=>trans('admin.to_city')]) !!}--}}
                        {!! Form::label('to_city',trans('admin.to_city'),['class'=>' control-label']) !!}
