 ...
 <div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="{{ aurl('/marketer/'.$id.'/edit')}}" class="dropdown-item" ><i class="fas fa-edit"></i> {{trans('admin.edit')}}</a>
		<a href="{{ aurl('/marketer/'.$id)}}" class="dropdown-item" ><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
		<a href="{{ aurl('/marketer/cleints/'.$id)}}" class="dropdown-item" ><i class="fa fa-eye"></i> {{trans('admin.cleint')}}</a>
