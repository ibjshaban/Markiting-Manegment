	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('cleint/'.$cleint->id.'/edit')}}">
				...
				<a data-toggle="modal" data-target="#deleteRecord{{$cleint->id}}" class="dropdown-item"  style="color:#343a40" href="#">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<i class="fa fa-exclamation-triangle"></i>  {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$cleint->id}})
					</div>
