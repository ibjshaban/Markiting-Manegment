...
class ShippingMarketerDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ...
            ->addColumn('country', '{{ trans("countries.".$country) }}')

            ->addColumn('vehicle_types', '{{ trans("admin.".$vehicle_types) }}')
    ...
    {
        return Shipping::query()->select("shippings.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,3,4', 'input') . "
                        ...
                        //countrycountry,vehicle_types,cost2

            //vehicle_typescountry,vehicle_types,cost3
...
[
				...
				[
                 'name'=>'shippings.country',
                 'data'=>'country',
                 'title'=>trans('admin.country'),
		    ],
				[
                 'name'=>'shippings.vehicle_types',
                 'data'=>'vehicle_types',
                 'title'=>trans('admin.vehicle_types'),
		    ],
				[
                 'name'=>'cost',
                 'data'=>'cost',
