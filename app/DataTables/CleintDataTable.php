...
class CleintDataTable extends DataTable
{
    ...
    {
        $status_id = Cleint::select('status')->get();
        return datatables($query)
            ->addColumn('actions', 'admin.cleint.buttons.actions')
            ...
            ->editColumn('status', 'admin.cleint.buttons.status')
            ->rawColumns(['checkbox', 'actions', "photo_profile", 'status']);
    }
    ...
    {
        return Cleint::query()->select("cleints.*");
