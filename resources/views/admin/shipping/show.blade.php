	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a class="dropdown-item"  style="color:#343a40" href="{{aurl('shipping/'.$shipping->id.'/edit')}}">
				...
				<a data-toggle="modal" data-target="#deleteRecord{{$shipping->id}}" class="dropdown-item"  style="color:#343a40" href="#">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<i class="fa fa-exclamation-triangle"></i>  {{trans('admin.ask_del')}} {{trans('admin.id')}} ({{$shipping->id}})
					</div>
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-xs-12">
				<b>{{trans('admin.id')}} :</b> {{$shipping->id}}
			</div>
