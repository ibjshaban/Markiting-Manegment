<!-- Navbar -->
<nav id="notification" class="main-header navbar navbar-expand
    ...
    <ul id="notification" class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            @if(Auth::guard('admin')->check())
                <a href="{{ aurl('logout') }}" class="nav-link"><i
                        class="nav-icon fas fa-sign-out-alt"></i> {{ trans('admin.logout') }}</a>
            @elseif(Auth::guard('marketer')->check())
                <a href="{{ url('marketer/logout') }}" class="nav-link"><i
                        class="nav-icon fas fa-sign-out-alt"></i> {{ trans('admin.logout') }}</a>
            @endif
        ...
        <li class="nav-item d-none d-sm-inline-block">
            ...
            @elseif(Auth::guard('marketer')->check())
                <a href="{{ aurl('lock/screen') }}?email={{ marketer()->user()->email }}" class="nav-link"><i
                        class="nav-icon fa fa-user-lock"></i> {{ trans('admin.lock_screen') }}</a>
            @endif
        </li>
        {{-- <li class="nav-item d-none d-sm-inline-block">
