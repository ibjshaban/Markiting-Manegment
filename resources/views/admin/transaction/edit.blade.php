...
@section('content')
    ...
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title">
                <div class="">
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a href="{{aurl('transaction')}}" class="dropdown-item" style="color:#343a40">
                            <i class="fas fa-list"></i> {{trans('admin.show_all')}} </a>
                        <a href="{{aurl('transaction/'.$transaction->id)}}" class="dropdown-item" style="color:#343a40">
                            <i class="fa fa-eye"></i> {{trans('admin.show')}} </a>
                        <a class="dropdown-item" style="color:#343a40" href="{{aurl('transaction/create')}}">
                            <i class="fa fa-plus"></i> {{trans('admin.create')}}
                        </a>
                        <div class="dropdown-divider"></div>
                        <a data-toggle="modal" data-target="#deleteRecord{{$transaction->id}}" class="dropdown-item"
            ...
            @push('js')
                <div class="modal fade" id="deleteRecord{{$transaction->id}}">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['url'=>aurl('/transaction/'.$transaction->id),'method'=>'put','id'=>'transaction','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        {!! Form::label('marketer_id',trans('admin.marketer_id'),['class'=>'control-label']) !!}
                        {!! Form::select('marketer_id',App\Models\Marketer::pluck('name_ar','id'), $transaction->marketer_id ,['class'=>'form-control select2','placeholder'=>trans('admin.marketer_id')]) !!}
                    </div>
                </div>
