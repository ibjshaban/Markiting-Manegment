    ...
    <div class="card card-outline card-primary">
        ...
        <!-- /.social-auth-links -->
            ...
            <div class="form-group">
                <div class="row">
                    <p class="mb-1 col-6" dir="{{app('dir')}}">
                        <a href="{{ url('marketer/forgot/password') }}">{{ trans('admin.forgot_password') }}</a>
                    </p>
                    <p class="mb-1 col-6" dir="{{app('dir')}}">
                        <a href="{{ url('marketer/register') }}" class="float-right">{{ trans('admin.register') }}</a>
                    </p>
                </div>
            </div>
            ...
            @if(count(L::all()) > 0)
                ...
                <center>
                    ...
                    @foreach(L::all() as $lang)
                        <a style="color:{{ app('l') == $lang?'#c33':'#343a40' }}"
