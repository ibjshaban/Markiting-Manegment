...
@section('content')
    ...
    <div class="card card-dark">
            ...
            <h3 class="card-title">
                <div class="">
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a href="{{aurl('cleint')}}" class="dropdown-item" style="color:#343a40">
                            <i class="fas fa-list"></i> {{trans('admin.show_all')}} </a>
                        <a href="{{aurl('cleint/'.$cleint->id)}}" class="dropdown-item" style="color:#343a40">
                            <i class="fa fa-eye"></i> {{trans('admin.show')}} </a>
                        <a class="dropdown-item" style="color:#343a40" href="{{aurl('cleint/create')}}">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['url'=>aurl('/cleint/'.$cleint->id),'method'=>'put','id'=>'cleint','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('to_country',$cleint->to_country,['class'=>'form-control','placeholder'=>trans('admin.to_country')]) !!}--}}
                        {!! Form::label('to_country',trans('admin.to_country'),['class'=>' control-label']) !!}
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('to_city',$cleint->to_city,['class'=>'form-control','placeholder'=>trans('admin.to_city')]) !!}--}}
                        {!! Form::label('to_city',trans('admin.to_city'),['class'=>' control-label']) !!}
